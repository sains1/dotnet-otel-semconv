...
### OtelSemConvAnalyzer.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [OtelSemConvAnalyzer.Sample.csproj](../OtelSemConvAnalyzer.Sample/OtelSemConvAnalyzer.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### OtelSemConvAnalyzer.Tests
